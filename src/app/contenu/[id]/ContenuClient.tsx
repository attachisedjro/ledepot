      ...
      <div className="pt-24 pb-16 px-6 max-w-5xl mx-auto">
        ...
        <div className="grid md:grid-cols-2 gap-10 items-start">
          ...
          <div className="space-y-6">
            ...
            {/* WhatsApp share */}
            <a
              href={`https://wa.me/?text=${encodeURIComponent(`Je te partage une campagne sur Le Dépôt :\n${contenu.titre} – ${contenu.marque}\nhttps://ledepot.createevesafrica.com/contenu/${contenu.slug ?? contenu._id}`)}`}
              target="_blank"
              rel="noopener noreferrer"
              className="flex items-center justify-center gap-2 w-full bg-[#25D366]/10 text-[#25D366] font-label font-medium px-6 py-3 rounded-xl text-sm hover:bg-[#25D366]/20 transition-colors"
            >
